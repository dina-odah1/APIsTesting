...
public class APIsTests {
    ...
    @Story("Story name: Querying users data against certain username should return user's data")
    @BeforeClass
    ...
    @Epic("Posts API Tests")
    @Story("Story name: Users should be able to successfully add new post via POST posts API")
